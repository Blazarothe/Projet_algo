...
void conditions(int choix,int *nmbre_joueursint ,int matrix[49][3][3]);
void depla(int matrix[49][3][3],int player, int compte_T,int compte_L,int compte_I,int compteL_tresors);
int menu();
