...
void nouvelle_partie(int *nmbre_joueurs,int matrix[49][3][3]) {
    ...
    while (nmbre_joueurs != 0) {
        depla(matrix, player, compte_T, compte_L, compte_I, compteL_tresors, deplacement);
        for (i = 0; i < *nmbre_joueurs; i++) {
            ...
            if (action == 1) {
                ...
                do {
                    ...
                    depla(matrix, player, compte_T, compte_L, compte_I, compteL_tresors,deplacement); //call la fonction pour que le joeuur se deplace
                } while (deplacement == 1);
            }
            if (action == 2) {
                choix = menu();
